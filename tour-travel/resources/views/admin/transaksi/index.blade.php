...
@section('title', 'Kemahasiswaan | Permohonan')

@section('header')
    <div class="col-sm-4">
        <form action="/kemahasiswaan/permohonan-layanan" method="get">
...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            {{-- <a href="{{ route('kemahasiswaan.permohonan-layanan.add') }}" class="btn btn-dark btn-sm mb-3">Tambah Data</a> --}}
