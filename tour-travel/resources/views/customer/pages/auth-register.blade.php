...
<body>
    ...
    <div class="wrapper">
        <div class="register">
            ...
            <img src="/gambar_wisata/background.png" class="bg-image"/>
            <div class="bg-form">
                <h3 class="title mb-3">Daftar Sekarang!</h3>
                <form>
                    <div class="mb-3">
                        <label for="default input example" class="form-label">Nama</label>
                        <input class="form-control" type="text" aria-label="default input example">
                    </div>
                    <div class="mb-3">
                        <label for="default input example" class="form-label">Nomor Telepon</label>
                        <input class="form-control" type="text" aria-label="default input example">
                    </div>
                    <div class="mb-3">
                        <label for="default input example" class="form-label">Alamat</label>
                        <input class="form-control" type="text" aria-label="default input example">
                    </div>
                    <div class="mb-3">
