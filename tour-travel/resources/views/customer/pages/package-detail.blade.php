    ...
    <div class="container landing"> 
        <div class="row">
            <div class="col-4 title mt-5">
                ...
                <h3 class="mt-5 card-price">{{ $paket_wisata->harga_paket }}</h3>
        ...
        <div class="my-3">
            ...
            <div class="d-flex justify-content-between">
                <a href="/customer/destination-detail" class="button-card">
                    <div class="card card-image" style="width: 18rem;">
                        <img src="/gambar_wisata/carousel_1.png" class="card-img-top" alt="...">
                        <div class="card-body">
